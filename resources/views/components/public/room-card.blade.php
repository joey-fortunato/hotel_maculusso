...
<a href="{{ route('rooms.show', [$locale, $room['slug']]) }}"
   class="group relative isolate flex aspect-[4/5] flex-col justify-end overflow-hidden bg-espresso-900 text-white shadow-sm transition duration-500 hover:shadow-xl sm:aspect-[4/3]">
