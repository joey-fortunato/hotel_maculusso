...
<a href="{{ route('rooms.show', [$locale, $room['slug']]) }}"
   class="group relative isolate flex aspect-[3/2] flex-col justify-end overflow-hidden bg-espresso-900 text-white shadow-sm transition duration-500 hover:shadow-xl">
    ...
    <div class="relative flex items-end justify-between gap-4 p-7 sm:p-8">
        ...
        <span aria-hidden="true"
              class="grid h-14 w-14 shrink-0 place-items-center border border-white/40 text-white transition duration-300 group-hover:border-copper-400 group-hover:bg-copper-500 group-hover:text-white">
